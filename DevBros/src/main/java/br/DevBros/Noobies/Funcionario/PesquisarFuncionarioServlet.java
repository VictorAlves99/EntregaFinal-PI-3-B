 ...
 */
@WebServlet(name = "PesquisarFuncionarioServlet", urlPatterns = {"/pesquisarFuncionario"})
public class PesquisarFuncionarioServlet extends HttpServlet {
    ...
    private void listaFuncionarios(String metodoHttp, HttpServletRequest request, HttpServletResponse response)
        ...
        List<Funcionario> funcionarios = FuncionarioDAO.listarFuncionarios(pesquisa);
        request.setAttribute("listaFuncionarios", this);
